    ...
    <div class="container">
      <div class="navbar">
        ...
        <div class="list-menu">
          <a href="">Home</a>
          <a href="">Categories</a>
          <a href="login.php" class="btn_login" style="color: white">Login</a>
        </div>
      </div>
        ...
        <div class="card-categories">
          <div class="card">
            ...
            <p>
              ...
              Ras ini berasal dari Ankara, Turki. Kucing ini sangat populer dan
          ...
          <div class="card">
            ...
            <h5>Persia</h5>
            <p>
              Kucing persia adalah ras kucing domestik berbulu panjang dengan
              karakter wajah bulat dan moncong pendek. Namanya mengacu pada
              Persia.
            </p>
          </div>
          <div class="card">
            ...
            <p>
              Kucing bulu pendek britania adalah salah satu ras kucing tertua di
              inggris. Kucing ini adalah kucing berbadan sedang dengan bulu yang
              pendek.
            </p>
          </div>
        </div>
